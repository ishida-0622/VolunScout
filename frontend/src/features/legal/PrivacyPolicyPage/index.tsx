export const PrivacyPolicyPage = () => <div>
    <ul>
      東京情報クリエイター工学院専門学校（以下，「当団体」といいます。）は，本ウェブサイト上で提供するサービス「VolunScout」（以下,「本サービス」といいます。）における，ユーザーの個人情報の取扱いについて，以下のとおりプライバシーポリシー（以下，「本ポリシー」といいます。）を定めます。
    </ul>
    <ul>
      第1条（個人情報）
    ...
    <ul>
      第2条（個人情報の収集方法）
      <li>当団体は，ユーザーが利用登録をする際に氏名，メールアドレスなどの個人情報をお尋ねすることがあります。</li>
    </ul>
    <ul>
      第3条（個人情報を収集・利用する目的）
    ...
    <ol>
      ...
      <li> 本人確認を行うため</li>
      <li>ユーザーが利用中のサービスの新機能，更新情報等のメールを送付するため</li>
    ...
    <ul>
      ...
      <li>1.当団体が利用目的の達成に必要な範囲内において個人情報の取扱いの全部または一部を委託する場合</li>
    ...
    <ol>
      ...
      <p>当団体は，本人から個人情報の開示を求められたときは，本人に対し，遅滞なくこれを開示します。ただし，開示することにより次のいずれかに該当する場合は，その全部または一部を開示しないこともあり，開示しない決定をした場合には，その旨を遅滞なく通知します。</p>
    ...
    <ul>
      <p>住所：〒101-0051 東京都千代田区神田神保町１丁目５０</p>
      <p>施設名：東京情報クリエイター工学院専門学校 担当：情報処理学科</p>
      <p>電話番号：03-3237-8711</p>
    </ul>
    <ul>以上</ul></div>;
